...
void test_head() {
    ...
    struct head_testcase tests[N_TESTCASES_HEAD] = {
      ...
      { {8, 1, -2}, 3, 8 },     // testea: head([8, 1, -2]) == 

      /* NUEVOS TESTS */
      { {6,6,6,6,6,6}, 6, 6 },  // testea: head([6,6,6,6,6,6) == 6
      { {1,1}, 2, 1 },          // testea: head([1, 1]) == 1
    };
...
void test_index() {
    ...
    struct index_testcase tests[N_TESTCASES_INDEX] = {
      ...
      /* NUEVOS TESTS */
      { {3,8 }, 2, 1, 8 },          // testea: index([3, 8] , 1) == 8
      { {3}, 1, 0, 3 },             // testea: index([3] , 0) == 3
    };
